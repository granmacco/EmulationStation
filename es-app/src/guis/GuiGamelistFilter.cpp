...
GuiGamelistFilter::GuiGamelistFilter(Window* window, SystemData* system) : GuiComponent(window), mMenu(window, "FILTRAR POR LISTA DE JUEGOS"), mSystem(system)
{
	initializeMenu();
}
...
void GuiGamelistFilter::initializeMenu()
{
	...
	mMenu.addButton("VOLVER", "volver", std::bind(&GuiGamelistFilter::applyFilters, this));
