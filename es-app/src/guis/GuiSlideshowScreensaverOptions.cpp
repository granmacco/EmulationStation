...
GuiSlideshowScreensaverOptions::GuiSlideshowScreensaverOptions(Window* window, const char* title) : GuiScreensaverOptions(window, title)
{
	...
	addWithLabel(row, "ESTIRAR LAS IMÁGENES", sss_stretch);
	...
	addEditableTextComponent(row, "AUDIO DE FONDO", sss_bg_audio_file, Settings::getInstance()->getString("SlideshowScreenSaverBackgroundAudioFile"));
	...
	addWithLabel(row, "UTILIZAR IMÁGENES PERSONALIZADAS", sss_custom_source);
	...
	addEditableTextComponent(row, "CARPETA DE IMÁGENES PERSONALIZADAS", sss_image_dir, Settings::getInstance()->getString("SlideshowScreenSaverImageDir"));
	...
	addWithLabel(row, "CARPETA RECURSIVA DE IMAGENES PERSONALIZADAS", sss_recurse);
	...
	addEditableTextComponent(row, "FILTRO DE IMÁGENES PERSONALIZADAS", sss_image_filter, Settings::getInstance()->getString("SlideshowScreenSaverImageFilter"));
