...
void SystemData::writeExampleConfig(const std::string& path)
{
	...
	file << "<!-- Este es el fichero de configuracion de Sistemas de EmulationStation.\n"
			"Todos los sistemas deben estar contenidos en el tag <systemList>.-->\n"
			"\n"
			"<systemList>\n"
			"	<!-- Aquí va un ejemplo para que vayas empezando. -->\n"
			"	<system>\n"
			"\n"
			"		<!-- Un nombre corto, usado internamente. Normalmente, en minúsculas. -->\n"
			"		<name>nes</name>\n"
			"\n"
			"		<!-- Un nombre \"bonito\", para mostrar en menús y similares. -->\n"
			"		<fullname>Nintendo Entertainment System</fullname>\n"
			"\n"
			"		<!-- La ruta a partir de la cuál buscar ROMs. '~' se convertirá en $HOME si usas Linux o en %HOMEPATH% si usas Windows. -->\n"
			"		<path>~/roms/nes</path>\n"
			"\n"
			"		<!-- Una lista de las extensiones de archivo las cuales buscar, usando como separador espacios en blanco (\" , \\r\\n\\t\").\n"
			"		¡DEBES incluir el punto al principio de la extensión! Además, las mayúsculas importan. -->\n"
			"		<extension>.nes .NES</extension>\n"
			"\n"
			"		<!-- The comando de consola a ejecutar cuando se seleccione un juego. Existen algunos tags especiales que se sustituiran si los usase en un comando:\n"
			"		%ROM% será sustituido por una ruta absoluta especial-para-bash-con-caracteres-escapados a la ROM.\n"
			"		%BASENAME% será sustituido por el nombre \"base\" de la ROM. Por ejemplo, \"/foo/bar.rom\" tendrá un nombre base de \"bar\". Útil para MAME.\n"
			"		%ROM_RAW% será sustituido por la ruta cruda, directa y sin escapar a la ROM. -->\n"
			"		<command>retroarch -L ~/cores/libretro-fceumm.so %ROM%</command>\n"
			"\n"
			"		<!-- La plataforma a utilizar cuando se scrapee. Puedes ver una lista completa de plataformas aceptadas en src/PlatformIds.cpp.\n"
			"		Las mayúsculas importan, pero todo se escribe en minúscula. Este tag es opcional.\n"
			"		También puedes utilizar múltiples plataformas, usando como separador espacios en blanco (\" , \\r\\n\\t\"), por ej: \"genesis, megadrive\" -->\n"
			"		<platform>nes</platform>\n"
			"\n"
			"		<!-- El tema a cargar del tema actual. Comprueba el fichero THEMES.md para más información.\n"
			"		Este tag es opcional. Si no existe, usará el mismo valor que el tag <name>. -->\n"
			"		<theme>nes</theme>\n"
			"	</system>\n"
			"</systemList>\n";
