...
MetaDataDecl gameDecls[] = {
	...
	{"sortname",    MD_STRING,              "",                 false,      "orden alfabético",      "introducir nombre corto"},
	{"desc",        MD_MULTILINE_STRING,    "",                 false,      "descripción",           "descripción del juego"},
	...
	{"rating",      MD_RATING,              "0.000000",         false,      "clasificación",         "introducir clasificación"},
	{"releasedate", MD_DATE,                "not-a-date-time",  false,      "fecha de lanzamiento",  "fecha de lanzamiento"},
	{"developer",   MD_STRING,              "unknown",          false,      "desarollador",          "desarrollador del juego"},
	{"publisher",   MD_STRING,              "unknown",          false,      "distribuidor",          "distribuidor o editor"},
	{"genre",       MD_STRING,              "unknown",          false,      "género",                "género del juego"},
	{"players",     MD_INT,                 "1",                false,      "jugadores",             "número de jugadores"},
	...
	{"playcount",   MD_INT,                 "0",                true,       "veces jugado",          "número de veces jugado"},
	{"lastplayed",  MD_TIME,                "0",                true,       "jugado por última vez", "fecha de última partida"}
};
